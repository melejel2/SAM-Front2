...
const PrivacyPolicy = () => {
    return (
        <>
            <MetaData title="Privacy Policy" noIndex />

            <div className="container mx-auto max-w-5xl p-4">
                <h1 className="mb-6 text-2xl font-bold">Privacy Policy</h1>
                <p className="mb-6 text-sm text-gray-500">Last Updated: Thursday, 22 August 2024</p>
                <div className="space-y-6">
                    ...
                    <section>
                        ...
                        <ul className="ml-4 list-inside list-disc space-y-2">
                            <li>
                                <strong>Personal Information:</strong> We collect information you provide directly, such
                                as your name, email address, phone number, and billing/shipping address when you create
                            ...
                            <li>
                                ...
                                such as device type, operating system, unique identifiers, and network information.
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                for troubleshooting and service improvement purposes.
                            </li>
                        </ul>
                    </section>
                    <section>
                        ...
                        <ul className="ml-4 list-inside list-disc space-y-2">
                            ...
                            <li>
                                To monitor usage trends and analyze how users engage with the App to improve
                                functionality.
                            </li>
                            <li>To ensure security and compliance with applicable legal obligations.</li>
                        </ul>
                    </section>
                    <section>
                        ...
                        <ul className="ml-4 list-inside list-disc space-y-2">
                            <li>
                                ...
                                service providers assisting us with App operations, data storage, or order processing,
                            ...
                            <li>
                                <strong>Business Transfers:</strong> In the case of a business transaction such as a
                                merger, your information may be transferred.
                            </li>
                        </ul>
                    </section>
                    <section>
                        ...
                        <ul className="ml-4 list-inside list-disc space-y-2">
                            ...
                            <li>
                                ...
                                following instructions in emails or contacting support.
                            </li>
                            <li>
                                <strong>Account Deletion:</strong> You can request deletion of your account by
                                contacting us. Certain information may be retained for operational or legal purposes.
                            </li>
                        </ul>
                    </section>
                    <section>
                        ...
                        <p>
                            We implement appropriate security measures to protect your data. However, no system is
                            completely secure, so please be mindful of the information you share.
                        </p>
                    </section>
                    <section>
                        <h2 className="text-xl font-semibold">7. Children’s Privacy</h2>
                        <p>
                            The App is not intended for children under 13, and we do not knowingly collect information
                            from children under 13. If we become aware of such data, it will be deleted promptly.
                        </p>
                    </section>
                    <section>
                        <h2 className="text-xl font-semibold">8. Changes to This Privacy Policy</h2>
                        <p>
                            We may update this policy periodically. Changes will be posted on this page with the "Last
                            Updated" date revised accordingly. Please check for updates.
                        </p>
                    </section>
                    <section>
                        <h2 className="text-xl font-semibold">9. Contact Us</h2>
                        <p>If you have any questions or concerns regarding this policy, please contact us at:</p>
                        <a href="mailto:support@karamentreprises.com">Email: support@karamentreprises.com</a>
                    </section>
                </div>
            </div>
        </>
