...
const dashboardPages = [
  ...
  },
  {
    ...
    description: 'Unified contract management system. Create drafts, manage active contracts, handle variation orders (VOs), and track terminated agreements with full document generation.',
