...
import type { SaveIPCVM, IpcStatus } from "@/types/ipc";
                    ...
                    <div className="card-body">
                        ...
                        <div className="space-y-3 mt-4">
                            ...
                            <div>
                                ...
                                <p className="font-semibold text-base-content mt-1">
                                    {currentProject?.name || navigationData?.projectName || ipcData.projectName || 'N/A'}
                                </p>
                            </div>
                            <div>
                                <span className="text-base-content/70 text-sm">Subcontractor:</span>
                                <p className="font-semibold text-base-content mt-1">
                                    {currentSubcontractor?.name || navigationData?.subcontractorName || ipcData.subcontractorName || 'N/A'}
                                </p>
                            </div>
                            <div>
                                ...
                                {ipcData.buildings && ipcData.buildings.length > 0 ? (
                                    ipcData.buildings.map((building, index) => (
                                        <div key={building.id || index} className="space-y-4">
                                            <div className="flex items-center gap-3">
                                                <h5 className="text-md font-semibold text-base-content">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div className="space-y-4">
                                        <h5 className="font-semibold text-base-content">Amounts</h5>
                                        <div className="space-y-3">
                                            <div className="flex justify-between">
                                                <span className="text-base-content/70">Current IPC Amount:</span>
                                                <span className="font-semibold">{currency} {formatCurrency(ipcData.totalAmount)}</span>
                                            </div>
                                            <div className="flex justify-between">
                                                <span className="text-base-content/70">Previous Payments:</span>
                                                <span>{currency} {formatCurrency(ipcData.paid)}</span>
                                            </div>
                                            <div className="flex justify-between">
                                                <span className="text-base-content/70">Advance Payment Amount:</span>
                                                <span>{currency} {formatCurrency(ipcData.advancePaymentAmount)}</span>
                                            </div>
                                            <div className="flex justify-between">
                                                <span className="text-base-content/70">Cumulative Advance:</span>
                                                <span>{currency} {formatCurrency(ipcData.advancePaymentAmountCumul)}</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    {/* Deductions */}
                                    <div className="space-y-4">
                                        <h5 className="font-semibold text-base-content">Deductions</h5>
                                        <div className="space-y-3">
                                            <div className="flex justify-between">
                                                <span className="text-base-content/70">Retention Amount:</span>
                                                <span>{currency} {formatCurrency(ipcData.retentionAmount)}</span>
                                            </div>
                                            <div className="flex justify-between">
                                                <span className="text-base-content/70">Retention Percentage:</span>
                                                <span>{formatPercentage(ipcData.retentionPercentage)}</span>
                                            </div>
                                            <div className="flex justify-between">
                                                <span className="text-base-content/70">Cumulative Retention:</span>
                                                <span>{currency} {formatCurrency(ipcData.retentionAmountCumul)}</span>
                                            </div>
                                            {ipcData.penalty && ipcData.penalty > 0 && (
                                                <div className="flex justify-between">
                                                    <span className="text-base-content/70">Penalty:</span>
                                                    <span className="text-red-600">-{currency} {formatCurrency(ipcData.penalty)}</span>
                                                </div>
                                            )}
                                            {ipcData.prorata && ipcData.prorata > 0 && (
                                                <div className="flex justify-between">
                                                    <span className="text-base-content/70">Prorata:</span>
                                                    <span>{currency} {formatCurrency(ipcData.prorata)}</span>
                                                </div>
                                            )}
                                        </div>
                                    </div>
                                ...
                                <div className="bg-base-200 p-4 rounded-lg">
                                    <h5 className="font-semibold text-base-content mb-3">Payment Summary</h5>
                                    <div className="space-y-2">
                                        <div className="flex justify-between">
                                            <span>Current IPC Amount:</span>
                                            <span>{currency} {formatCurrency(ipcData.totalAmount)}</span>
                                        </div>
                                        <div className="flex justify-between">
                                            <span>Less: Retention ({formatPercentage(ipcData.retentionPercentage)}):</span>
                                            <span>-{currency} {formatCurrency(ipcData.retentionAmount)}</span>
                                        </div>
                                        <div className="flex justify-between">
                                        ...
                                        <div className="flex justify-between text-lg font-bold">
                                            ...
                                            <span className="text-primary">{currency} {formatCurrency(netPayment)}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
