...
export const Step2_TradeSelection: React.FC = () => {
    const { formData, setFormData, projects, trades, allBuildings, loading } = useWizardContext();
    ...
    }); // Trades already filtered in WizardContext to only include those with BOQ data
