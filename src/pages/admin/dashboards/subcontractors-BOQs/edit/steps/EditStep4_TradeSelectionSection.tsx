...
interface TradeSelectionSectionProps {
    ...
    onTradeToggle: (tradeId: number, checked: boolean) => void;
}

export const EditTradeSelectionSection: React.FC<TradeSelectionSectionProps> = ({
    trades,
    selectedTrades,
    onTradeToggle
}) => {
                    ...
                    {selectedTrades.length === 0 ? (
                        ...
                        <div className="flex items-center gap-2 flex-wrap">
                            {selectedTrades.map(tradeId => {
                                ...
                                return trade ? (
                                    <div key={tradeId} className="badge badge-primary badge-sm">
                                        {trade.name}
                                    </div>
                                ) : null;
                            })}
