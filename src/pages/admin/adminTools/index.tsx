...
const AdminToolsPage = () => {
  ...
  const adminTools = [
    ...
    },
    {
      ...
      description: 'Manage variation order templates',
      path: '/admin-tools/templates/VO',
      status: 'active' as const,
      colorClass: 'bg-blue-600',
    },
    {
      title: 'Terminate Templates',
      icon: 'lucide--file-x',
      description: 'Manage termination document templates',
      path: '/admin-tools/templates/terminate',
      status: 'active' as const,
      colorClass: 'bg-blue-600',
    },
    {
      title: 'Decharge Templates',
      icon: 'lucide--file-check',
      description: 'Manage decharge document templates',
